...
export default function Home() {
  ...
  return (
    <main
      className="relative min-h-screen h-full bg-cover bg-center bg-no-repeat bg-fixed"
      style={{ backgroundImage: "url('/bg.jpg')" }}
    >
      {/* Content */}
      <div className="relative z-10 flex flex-col items-center justify-center min-h-screen h-full px-4 py-10 sm:py-0">
        <div className="bg-[#f7f1e8]/80 backdrop-blur-md p-6 sm:p-8 rounded-2xl max-w-xl w-full text-center shadow-xl">
